! function (e) {
    ...
    class O {
        ...
        _initObservers() {
            C(this, M, new MutationObserver(e => {
                e.forEach(e => {
        ...
        _initMenu() {
            ...
            this.node.pnls = g("div.mm-panels"), this.node.menu.append(this.node.pnls), e.forEach(e => {
                this._initPanel(e)
        ...
        _initPanel(e) {
            ...
            if (!e.matches(".mm-panel") && (y(e, this.conf.classNames.panel, "mm-panel"), y(e, this.conf.classNames.nopanel, "mm-nopanel"), !e.matches(".mm-nopanel"))) {
                ...
                return e.classList.add("mm-panel"), e.tabIndex = -1, (null === (t = e.parentElement) || void 0 === t ? void 0 : t.matches(".mm-listitem--vertical")) || this.node.pnls.append(e), this._initNavbar(e), _(e, "ul, ol").forEach(e => {
        ...
        _initNavbar(e) {
            ...
            const o = g("span");
            var l;
            o.innerHTML = e.dataset.mmTitle || ((l = i) ? [].slice.call(l.childNodes).filter(e => e.nodeType === Node.TEXT_NODE).map(e => e.nodeValue.trim()).join(" ") : "") || this.i18n(this.opts.navbar.title) || this.i18n("Menu"), e.prepend(s), s.append(a), a.append(o), this.trigger("initNavbar:after", [e])
        }
        _initListview(e) {
    ...
    O.prototype.open = function () {
        ...
        null === (e = this.node.open || document.querySelector(`[href="#${this.node.menu.id}"]`) || O.node.page || null) || void 0 === e || e.focus(), document.body.scrollLeft = 0, document.documentElement.scrollLeft = 0, this.trigger("close:after")
    ...
    const J = function () {
        ...
        ee = function (e = !1) {
            ...
            if (n.cancel && e) {
                ...
                e.href = "#", e.title = this.i18n("Cancel searching"), e.textContent = this.i18n("cancel"), s.append(e), e.addEventListener("click", e => {
    ...
    O.addons = {
        offcanvas: function () {
            ...
            n.includes(e.position) || (e.position = n[0]), this._api.push("open", "close", "setPage"), this.bind("initMenu:before", () => {
                ...
                var t, n;
                (null === (t = document.activeElement) || void 0 === t ? void 0 : t.closest("#" + this.node.menu.id)) && !this.node.menu.matches(".mm-menu--opened") && this.open(), (null === (n = document.activeElement) || void 0 === n ? void 0 : n.closest("#" + this.node.menu.id)) || this.node.wrpr.matches(".mm-wrapper--sidebar-expanded") || !this.node.menu.matches(".mm-menu--opened") || this.close()
            })
        },
        ...
        sectionIndexer: function () {
            ...
            a(this.opts.sectionIndexer, le).add && this.bind("initPanels:after", () => {
                if (!this.node.indx) {
                    let e = "";
            ...
            if ("detect" == e.current) {
                const e = t => {
                    ...
                    if (n) this.setSelected(n.parentElement);
                        ...
                        const n = t.split("index.html").slice(0, -1);
                        n.length && e(n.join("index.html"))
                    }
                };
                this.bind("initMenu:after", () => {
